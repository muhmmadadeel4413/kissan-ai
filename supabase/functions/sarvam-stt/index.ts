 ...
 * - Urdu, English, and Punjabi are supported through Sarvam language codes.
 */
...
function corsForOrigin(
  ...
  /**
   * Only return Access-Control-Allow-Origin when the
   * requesting origin is explicitly allowed.
   *
   * IMPORTANT:
   * Unknown origins do NOT receive localhost as a fallback.
   */
  if (
    origin &&
