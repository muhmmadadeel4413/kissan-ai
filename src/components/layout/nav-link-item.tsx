...
export function NavLinkItem({
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          "group relative flex items-center gap-2.5 rounded-lg px-2.5 py-[5px] text-[13px] font-medium transition-all duration-150 cursor-pointer",
          isActive
    ...
    >
      {({ isActive }) => (
        <>
          ...
          <span
            className={cn(
              "absolute left-0 top-1/2 h-4 w-1 -translate-y-1/2 rounded-full bg-accent transition-all duration-200",
