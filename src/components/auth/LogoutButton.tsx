...
export function LogoutButton({
  ...
  return (
    <button
      ...
      disabled={busy}
      className={cn(
        "flex w-full items-center justify-center gap-2 rounded-xl border border-sidebar-border bg-sidebar-accent px-3 py-2 text-sm font-medium text-red-300 transition-colors hover:bg-[#3a4a33] disabled:opacity-60 cursor-pointer",
        className
      )}
    >
