      ...
      >
        ...
        <div className="hidden items-center gap-0.5 lg:flex xl:gap-1">
          {DESKTOP_LINKS.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="whitespace-nowrap rounded-full px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-primary-soft hover:text-primary cursor-pointer xl:px-3.5"
            >
              {t(link.key)}
            </a>
          ))}
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            className="whitespace-nowrap font-semibold text-foreground hover:bg-primary-soft hover:text-primary"
          >
            <Link to="/login">{t("nav.login")}</Link>
          </Button>
          <Button asChild size="sm" className="whitespace-nowrap shadow-soft">
