  ...
  return (
    <Card className="h-full">
      <CardContent className="flex h-full flex-col gap-3 p-5">
        ...
        {status === "loading" ? (
          <div className="flex-1 space-y-2" role="status" aria-label="Loading crop health">
          ...
          <div className="flex flex-1 flex-col items-start gap-2">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              We couldn't load your latest crop check.
            </p>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="flex flex-1 flex-col items-start gap-2">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              Run the AI Crop Doctor to get your first health check.
            </p>
